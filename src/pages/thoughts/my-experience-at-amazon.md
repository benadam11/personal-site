...
I found this to be a very helpful practice that I think would benefit organizations of all sizes, however it does reinforce that people are not the source of truth for information which leads to my next implication.
...
I think everyone’s experience at a big company will vary by organization and even by team. In my case, the team I reported into has actually been phenomenal. The team was incredibly supportive of one another and makes really great efforts to stay connected especially operating as a remote team. We had a good cadence for meeting as a team (2x a week), and the team had a top tier manager. I have learned a lot working under this manager. She was tough and pushed everyone to dig deeper and not settle for what’s easy, but she was also kind and joyful (what a powerful combination). I also really admired how responsible and good at communicating / followup everyone on the team is (our 2 researchers in particular). They add so much value to every aspect of the surface area we cover.

I also really enjoyed the opportunity to get more hands on experience with AWS. That 10% has been fun - contributing to a Vue.js app that generates marketing graphics - migrating from EventBus to Vuex, adding routing etc). I migrate the app from an EC2 instance to S3 + Cloudfront (using Lambda Edge for authentication). I also got to do a deep dive on permissions and learned a lot about Cognito (user & identity pools) and IAM roles (while integrating with an external OAuth provider). I wish that I could have gotten more hands on experience with Dynamo DB. There is a perfect project for using it and it would be fun to work on data modeling and building an API to power our front end app but also extend its a capabilities to be able to generate graphics with a service. Unfortunately this work probably falls in the high impact low priority category and wont be executed any time soon.

I don’t regret my decision to work at Amazon. I learned a lot in a really short amount of time, but I also realize that it was not the place for me long term and I am at peace with that. On to the next one.
